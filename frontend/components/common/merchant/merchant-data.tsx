...
const MERCHANT_ACTIONS = [
  ...
  },
  {
    ...
    action: "online-payment" as const,
  },
];
...
function MerchantDataContent({ apiKey }: MerchantDataProps) {
  ...
  const [selectedQuickSelection, setSelectedQuickSelection] = React.useState<
    string | null
  >("最近 1 个月");
  const [dateRange, setDateRange] = React.useState<{
    from: Date;
    to: Date;
  } | null>(getDefaultDateRange);
      ...
      <div>
        ...
        <div className="space-y-2">
          ...
          <TransactionTableList
            ...
            onRetry={() =>
              fetchTransactions({ page: 1, client_id: apiKey.client_id })
            }
