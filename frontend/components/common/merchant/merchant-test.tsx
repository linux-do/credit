              ...
              {pendingValue ? (
                <>
                  ...
                  <ul className="space-y-2 ml-4 list-disc text-muted-foreground">
                    <li>
                      <strong>订单不会真实扣费</strong>：用户余额不会扣减
                    </li>
                    <li>
                      <strong>商户不会收款</strong>：你的余额不会增加
                    </li>
                    <li>
                      <strong>仅限自己测试</strong>：只有你可以支付测试订单
                    </li>
                    <li>
                      <strong>订单标记明显</strong>：测试订单会显示警告标识
                    </li>
                  </ul>
                  <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-3">
                    <p className="text-xs text-orange-800 dark:text-orange-300">
                      <strong>使用场景：</strong>
                      在正式上线前测试支付流程、回调通知等功能
                    </p>
                  </div>
                </>
              ) : (
                <>
                  ...
                  <ul className="space-y-2 ml-4 list-disc text-muted-foreground">
                    <li>
                      <strong>订单真实扣费</strong>：用户余额会正常扣减
                    </li>
                    <li>
                      <strong>商户正常收款</strong>：你的余额会正常增加
                    </li>
                    <li>
                      <strong>其他用户可支付</strong>：任何人都可以支付订单
                    </li>
                    <li>
                      <strong>正式生产环境</strong>：可以接收真实的业务订单
                    </li>
                  </ul>
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
                    <p className="text-xs text-green-800 dark:text-green-300">
                      <strong>注意：</strong>
                      关闭后应用将进入生产模式，请确保已完成测试
                    </p>
                  </div>
                </>
              )}
