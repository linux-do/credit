...
export const howToUseSections: PolicySection[] = [
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <strong>身份认证：</strong>基于 LINUX DO Connect (OAuth)
          </li>
          <li>
            <strong>认证方式：</strong>账户积分消耗认证
          </li>
          <li>
            <strong>手续费：</strong>动态费率，由服务方承担
          </li>
          <li>
            <strong>争议处理：</strong>支持服务方与消费方的双方争议处理
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <strong>服务方：</strong>最终积分流转的转入方
          </li>
          <li>
            <strong>消费方：</strong>最终积分流转的转出方
          </li>
          <li>
            <strong>认证平台：</strong>LINUX DO Credit 系统本身
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <h3
          id="3-1-api"
          className="text-base md:text-lg font-semibold text-foreground mt-6 md:mt-8 mb-3 md:mb-4"
        >
          3.1 使用 API 接口
        </h3>
        <ol className="list-decimal pl-4 md:pl-5 space-y-2">
          <li>
            ...
            <ul className="list-disc pl-4 md:pl-5 mt-2 space-y-1 text-muted-foreground">
              <li>
                前往{" "}
                <a href="/merchant" className="text-primary hover:underline">
                  集市中心
                </a>
              </li>
              <li>
                点击顶部右侧 <strong>创建应用</strong> 按钮
              </li>
          ...
          <li>
            ...
            <ul className="list-disc pl-4 md:pl-5 mt-2 space-y-1 text-muted-foreground">
              ...
              <li>
                在 <strong>API 配置</strong> 面板中获取：
                <ul className="list-[circle] pl-4 md:pl-5 mt-1">
                  <li>
                    <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">
                      Client ID
                    </code>
                    ：客户端ID，用于标识您的身份
                  </li>
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2 mb-4">
          <li>
            <strong>适用场景：</strong>无代码开发基础，或只用于简单的积分服务。
          </li>
          <li>
            <strong>操作步骤：</strong>
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2 mb-4">
          <li>
            <strong>适用场景：</strong>New API 站点，LINUX DO Credit 兼容
            EasyPay 协议，公益站站长可直接集成。
          </li>
          <li>
            <strong>操作步骤：</strong>
            <ol className="list-decimal pl-4 md:pl-5 mt-2 space-y-2 text-muted-foreground">
              <li>
                ...
                ，点击 <strong>创建应用</strong>，填写 New API 站点信息：
                <div className="my-4">
                  <DocsTable>
                    <DocsTableHeader>
                      <DocsTableRow>
                    ...
                    <DocsTableBody>
                      <DocsTableRow>
                        ...
                        <DocsTableCell>
                          <code className="bg-muted px-1 rounded text-xs before:content-none after:content-none">
                            您的应用名称
                          </code>
                        </DocsTableCell>
                      </DocsTableRow>
              ...
              <li>
                前往 New API 站点的系统设置，找到 <strong>支付设置</strong>。
              </li>
              <li>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          您可以在任意支持 LINUX DO Credit 的平台下使用积分。在其他平台点击使用
          LINUX DO Credit 积分时，会自动跳转到 LINUX DO Credit
          的积分流转服务页面，您只需要确认积分流转信息无误，并选择使用 LINUX DO
          Credit 进行账户认证，即可完成整个交易服务。
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        ...
        <p>
          为了更好的维持 LINUX DO Credit
          平台的积分服务机制，保证社区积分的生态可持续发展，我们会按照规范进行不同程度的服务（手续）费用收取。
        </p>
        <ul className="list-disc pl-4 md:pl-5 space-y-2">
          <li>
            <strong>承担方：</strong>服务（手续）费默认
            <strong>由服务方承担</strong>
          </li>
          <li>
            <strong>消费方使用：</strong>不会产生额外费用
          </li>
          <li>
            <strong>服务方实收：</strong>订单金额 - 服务（手续）费
          </li>
        </ul>
        <div className="mt-4">
...
商家实际到账 = 订单金额 - 手续费`}
      ...
      <div className="space-y-4 text-sm leading-relaxed">
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2">
          <li>
            ...
            <ol className="list-decimal pl-4 md:pl-5 mt-1 text-muted-foreground">
              <li>
                在集市中心或通知中查看到 <strong>待处理的争议</strong>
              </li>
              <li>
                查看消费方理由，选择操作：
                <ul className="list-[circle] pl-5 mt-1">
                  <li>
                    <strong>同意：</strong>认可消费方诉求，积分原路退回给消费方
                  </li>
                  <li>
                    <strong>拒绝：</strong>如果您认为已履约，请提交相关证据
                  </li>
                </ul>
              </li>
            </ol>
        ...
        <div className="bg-yellow-500/10 border border-yellow-500/20 text-yellow-600 dark:text-yellow-400 px-3 py-2 rounded-lg mt-4">
          <p className="m-0 text-sm">
            <strong>重要：</strong>
            建议服务方与消费方优先沟通解决。长时间未处理的争议会由 LINUX DO
            Credit 平台介入仲裁，这可能会影响您的服务方信誉。
          </p>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          您的 LINUX DO Credit 平台基础积分主要由{" "}
          <strong>社区积分 (Community Balance)</strong> 划转而来。
        </p>
        <ul className="list-disc pl-4 md:pl-5 space-y-2">
          <li>
            <strong>基本获取方式：</strong>通过在 LINUX DO 社区的活跃行为获得：
            <ul className="list-[circle] pl-4 md:pl-5 mt-1 text-muted-foreground">
              <li>点赞、阅读、解决问题等社区贡献</li>
              <li>
                详情可见{" "}
                <a
                  href="https://linux.do/t/topic/1355933"
                  target="_blank"
          ...
          <li>
            ...
            <ul className="list-[circle] pl-4 md:pl-5 mt-1 text-muted-foreground">
              <li>
                划转时间：社区积分每日凌晨 <strong>00:00</strong>{" "}
                自动划转至可用余额
              </li>
              <li>限制说明：划转前不可用于任何积分服务</li>
              <li>
                服务费用：目前不收取任何划转 <strong>服务费</strong>
              </li>
            </ul>
          </li>
        </ul>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          您可以在 <strong>设置 (Settings)</strong> 页面管理您的账户信息。
        </p>
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-1">
          <li>
            <strong>个人资料：</strong>查看当前的账户信息和会员等级
          </li>
          <li>
            <strong>安全设置：</strong>修改认证密码
          </li>
          <li>
            <strong>外观设置：</strong>切换页面主题、界面外观
          </li>
        </ul>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        <p>
          为了方便用户随时查看当前的实时积分收入，我们提供了开源的 Userscript
          脚本。
        </p>
        <ul className="list-disc pl-4 md:pl-5 space-y-2">
          <li>
            <strong>功能：</strong>在 LINUX DO
            显示实时积分收入，支持拖拽，不影响界面。
          </li>
          <li>
            <strong>获取：</strong>仅需安装 Tampermonkey 插件即可使用。
          </li>
          <li>
            <strong>安装：</strong>
            <a
