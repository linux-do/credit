...
export const DOCS_LAST_UPDATED = "2025-12-30";
    ...
    content: (
      <div className="space-y-4 text-sm leading-relaxed">
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2">
          <li>
            <strong>协议：</strong>EasyPay / CodePay / VPay 兼容协议
          </li>
          <li>
            <strong>服务类型：</strong>仅支持{" "}
          ...
          <li>
            <strong>订单有效期：</strong>取系统配置{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">
              merchant_order_expire_minutes
            </code>
            （平台端设置）
          </li>
        </ul>
        ...
        <h4 className="font-medium text-foreground mt-3 md:mt-4 mb-2">
          2.4.1 API Key
        </h4>
        <ul className="list-disc pl-4 md:pl-5 space-y-2 mb-4">
          ...
          <li>
            ...
            ；请求体中的 notify_url 仅参与签名，不会覆盖创建应用时设置的
            notify_url。
          </li>
        </ul>
...
sign=$(echo -n "\${payload}\${SECRET}" | md5)  # 输出小写`}
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2 mb-6">
          ...
          <li>
            <strong>成功：</strong>
            验签通过后，平台自动创建积分流转服务，并跳转到认证界面（Location=
            <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">
          ...
          <li>
            <strong>失败：</strong>返回 JSON{" "}
            <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">{`{"error_msg":"...", "data":null}`}</code>
          </li>
        </ul>
  ...
  "status": 1
        ...
        <p className="text-muted-foreground text-xs">
          <strong className="text-foreground">补充：</strong>
          <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">
            status
          </code>{" "}
          1=成功，0=失败/处理中；不存在会返回 HTTP 404 且{" "}
          <code className="bg-muted px-1.5 py-0.5 rounded text-xs font-mono before:content-none after:content-none">{`{"code":-1,"msg":"服务不存在或已完成"}`}</code>
          。
        </p>
        ...
        <p className="text-muted-foreground text-xs">
          <strong className="text-foreground">常见失败：</strong>
          服务不存在/未认证、金额不合法（&lt;=0 或小数超过 2 位）。
        </p>
        ...
        <ul className="list-disc pl-4 md:pl-5 space-y-2 mb-6">
          <li>
            <strong>触发：</strong>认证成功后；失败自动重试，最多 5 次（单次 30s
            超时）
          </li>
          <li>
            <strong>目标：</strong>创建应用时设置的 notify_url
          </li>
          <li>
            <strong>方式：</strong>HTTP GET
          </li>
        </ul>
