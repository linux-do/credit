          ...
          <Table className="w-full caption-bottom text-sm min-w-full">
            <TableHeader className="sticky top-0 z-20 bg-background">
              <TableRow className="border-b border-dashed hover:bg-transparent">
                ...
                <TableHead className="text-right whitespace-nowrap min-w-[80px] py-2 h-8 font-mono">
                  余额
                </TableHead>
                <TableHead className="text-right whitespace-nowrap min-w-[80px] py-2 h-8 font-mono">
                  基准分
                ...
                <TableHead className="text-right whitespace-nowrap min-w-[80px] py-2 h-8 font-mono is-last-money">
                  总划转
                </TableHead>
                <TableHead className="whitespace-nowrap min-w-[140px] py-2 h-8 pl-4">
                  上次登陆
                </TableHead>
                ...
                <TableHead className="sticky right-0 text-center bg-background z-10 w-[80px] py-2 h-8">
                  操作
                </TableHead>
              </TableRow>
            </TableHeader>
                          ...
                          <TooltipTrigger asChild>
                            ...
                            >
                              <Loader2
                                className={cn(
                                  "size-3",
                                  updatingUserId === user.id && "animate-spin"
                                )}
                              />
                            </Button>
                          </TooltipTrigger>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="rounded-lg border divide-y bg-background/50">
                        <div className="flex items-center justify-between p-3.5">
                          ...
                          <span className="font-mono text-[10px] font-medium text-purple-600 dark:text-purple-400">
                            +{Number(selectedUser.total_community).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex items-center justify-between p-3.5">
                          <span className="text-[10px]">累计收入</span>
                          <span className="font-mono text-[10px] font-medium text-green-600">
                            +{Number(selectedUser.total_receive).toFixed(2)}
                          </span>
                        </div>
                        <div className="flex items-center justify-between p-3.5">
                          <span className="text-[10px]">累计支出</span>
                          <span className="font-mono text-[10px] font-medium text-red-500">
                            {Number(selectedUser.total_payment) === 0
                              ? "0.00"
                              : `-${Number(selectedUser.total_payment).toFixed(2)}`}
                          </span>
                        </div>
                        <div className="flex items-center justify-between p-3.5">
                          <span className="text-[10px]">累计转账</span>
                          <span className="font-mono text-[10px] font-medium text-blue-500">
                            {Number(selectedUser.total_transfer).toFixed(2)}
                          </span>
                        </div>
                      </div>
                    </div>
