...
function LoadingCard() {
  return (
    <div className="relative w-[240px] aspect-[1.586] mx-auto perspective-1200 group">
      <div
        className={cn(
          "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] blur-[80px] pointer-events-none transition-colors duration-1000 bg-primary/10"
        )}
      />
      ...
      >
        ...
        <div
          className={cn(
            "absolute inset-0 rounded-2xl bg-[#1a1a1a] shadow-2xl border border-white/10 overflow-hidden backdrop-blur-xl"
          )}
        >
        ...
        <div
          className={cn(
            "absolute inset-0 rounded-2xl translate-z-[-2px] border border-white/5 bg-[#0f0f0f]"
          )}
          style={{ transform: "translateZ(-2px)" }}
        />
        <div
          className={cn(
            "absolute inset-0 rounded-2xl translate-z-[-4px] border border-white/5 bg-[#0f0f0f]"
          )}
      ...
      <div className="w-full max-w-md mx-auto text-center px-4 flex flex-col items-center gap-8">
        ...
        <div className="space-y-3 w-full flex flex-col items-center">
          ...
          >
            ...
            <span className="text-4xl font-serif font-bold italic text-primary">
              Credit
            </span>
            ...
            {badgeText && (
              <div className="absolute left-full top-1/3 -translate-y-1/2 ml-2">
                <Badge
                  variant="outline"
                  className="text-[10px] px-1.5 py-0 h-5 border-foreground/20 text-muted-foreground whitespace-nowrap"
                >
                  {badgeText}
                </Badge>
              </div>
