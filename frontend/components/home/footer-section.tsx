        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20">
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-base leading-relaxed max-w-sm">
              专为 LINUX DO
              社区打造的积分服务基础服务设施，快速集成、全球覆盖、安全可靠，致力于打造积分生态，助您轻松流通积分。
            </p>
            <div className="flex gap-4 pt-2">
              <SocialLink
                icon={Github}
                href="https://github.com/linux-do/credit/"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li>
                <FooterLink href="https://github.com/linux-do/credit/commits/master/">
                  更新日志
                </FooterLink>
              </li>
              <li>
                <FooterLink href="https://github.com/linux-do/credit/graphs/contributors">
                  开源贡献
                </FooterLink>
              </li>
              <li>
                <FooterLink href="http://github.com/linux-do/credit/releases">
                  发行版本
                </FooterLink>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li>
                <FooterLink href="/docs/how-to-use">使用文档</FooterLink>
              </li>
              <li>
                <FooterLink href="/docs/api">API 文档</FooterLink>
              </li>
              <li>
                <FooterLink href="https://linux.do/t/topic/1365853">
                  积分脚本
                </FooterLink>
              </li>
            </ul>
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li>
                <FooterLink href="https://linux.do/">LINUX DO</FooterLink>
              </li>
              <li>
                <FooterLink href="https://wiki.linux.do/">
                  LINUX DO Wiki
                </FooterLink>
              </li>
              <li>
                <FooterLink href="https://cdk.linux.do/">
                  LINUX DO CDK
                </FooterLink>
              </li>
            </ul>
